...
def run(test=False):
    ...
    chem_pot_inp = numpy.arange(
        -26, -15, 1
    )  # make sure to input negative numbers; # could also use numpy.linspace() or numpy.arange() if you import numpy
