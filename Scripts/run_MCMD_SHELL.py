...
def run(test=False):
    frame = system.read_lammps(
        "POLYMER_SYSTEM.lmps"
    )  # change name depending on your polymer LAMMPS file
    ...
    md_props = {
        "temp": temp,  # See LAMMPS (https://www.lammps.org) for understanding of these variables
        "pressure": {"start": press, "iso": "iso"},
        "kspace_style": 1e-5,
        "timestep": 0.5,
        "cutoff": 15.0,
        "length": 2000000,
