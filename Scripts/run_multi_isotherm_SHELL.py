...
def run(test=True):
    ...
    molec2mmols_g = 1e3 / frame.mass  # molecules -> mmol/g
    ...
    def calculate_isotherm_point_multi(gas_names, press):
        ...
        css.add_gcmc(
            species=gases,  # all parameters defined above; do not change this function
            is_rigid=isrigid,
            max_ins=maxins,
        ...
        css.run()
        full_prp = css.run_queue[
            0
        ].get_prp()  # getting columns from the prp file created by Cassandra
