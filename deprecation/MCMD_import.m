...
%   UNTITLED = IMPORTFILE(FILENAME)
%   Reads data from text file FILENAME for the default selection.
%
%   UNTITLED = IMPORTFILE(FILENAME, STARTROW, ENDROW)
%   Reads data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   Untitled = importfile('1.gcmc.prp', 4, 20003);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2023/07/13 13:52:22
...
Untitled = table(dataArray{1:end-1}, 'VariableNames', {'VarName5'});
